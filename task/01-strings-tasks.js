...
function unbracketTag(str) {
    var array = str.split('');
    array = array.splice(1, str.length-2);
    str = array.join("");
    return str;
}
...
function encodeToRot13(str) {
    ...
    var inputStr = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ?!';
    var arrayInput = inputStr.split('');

    var outputStr = 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm ?!';
    var arrayOutput = outputStr.split('');

    for( var i = 0; i<str.length; i++){ 
        var currentIndex = arrayInput.indexOf(array[i]);
        result.push(arrayOutput[currentIndex]);
